# Network Interface
resource "azurerm_network_interface" "eh_ctf_group5-vm-dc-nic" {
  name                 = "eh_ctf_group5-vm-dc-nic"
  ...
  ip_configuration {
    name                          = "eh_ctf_group5-vm-dc-config"
...
# Virtual Machine
resource "azurerm_windows_virtual_machine" "eh_ctf_group5-vm-dc" {
  name                     = "eh_ctf_group5-vm-dc"
  ...
  network_interface_ids    = [
    azurerm_network_interface.eh_ctf_group5-vm-dc-nic.id,
  ]

  os_disk {
    name                 = "eh_ctf_group5-vm-dc-osdisk"
    caching              = "ReadWrite"
